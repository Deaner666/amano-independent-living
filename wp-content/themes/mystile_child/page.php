		...
		<section id="main" class="col-left">
            ...
            <?php
                ...
                <article class="full-width-feature light">
                    <?php echo do_shortcode( '[wooslider slider_type="products" animation="slide" smoothheight="false" pause_on_hover="true" control_nav="false" size="medium" link_title_to_product="true" display_only_featured="true"]' ) ?>
                </article>
